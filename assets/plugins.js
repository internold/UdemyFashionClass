  ...
  ui: {
    stickyHeader: function() {
      ...
      $(document).scroll(function() {
        var navHeight = $("header").innerHeight() + $('.nav-bar-section').innerHeight(); 
        var y = $(document).scrollTop(), 
            header = $("header .menu-part"); 
        if(y >= navHeight){
          if( parseInt($(window).height()+navHeight+200) < parseInt($('html').height()) ){
    ...
    misc: function() {
      ...
      // Quantity Counter 
      $(function() {
        $('.produ_qty.plus').on('click', function() {
          var $qty = $(this).parents('.QuantityBox').find("li .QuantityInput");
          var currentVal = parseInt($qty.val(), 10);
          if (!isNaN(currentVal)) {
            $qty.val(currentVal + 1);
          }
        });
        $('.produ_qty.minus').on('click', function() {
          var $qty = $(this).parents('.QuantityBox').find("li .QuantityInput");
          var currentVal = parseInt($qty.val(), 10);
      ...
      $(function() {
        $('.cart_qty.plus').on('click', function() {
          var $qty = $(this).parents('.QuantityBox').find("li .QuantityInput");
          var currentVal = parseInt($qty.val(), 10);
          if (!isNaN(currentVal)) {
            $qty.val(currentVal + 1);
        ...
        $('.cart_qty.minus').on('click', function() {
          var $qty = $(this).parents('.QuantityBox').find("li .QuantityInput");
          var currentVal = parseInt($qty.val(), 10);
      ...
      if ($(window).width() >= 768) {
        function setHeight() {
          var SlideHeight = $('.home-slider').height() / 2;
          $('.home-banner figure').css('height', SlideHeight);
        }
        setHeight();
        ...
        jQuery('.home-banner figure img').each(function() {
          var el = $(this),
              src = el.attr('src'),
              parent = el.parent();
          parent.css({
    ...
    metisNavMenu: function() {
      if ($(window).width() <= 992) {
        $('.topbar-nav ul.metismenu').attr('id', 'primary_nav');
        $('#primary_nav').metisMenu();
        ...
        $(".close-nav").on('click', function() {
          ...
          return $(".navbar-expand-toggle").removeClass("fa-rotate-90");
        });
      }
    }, // end metisMenu
  }, // end ui
...
function change_thumbSlider(){

  Engine.utils.sliders();
}

$(document).on('shopify:section:load', change_thumbSlider)
.on('shopify:section:unload', change_thumbSlider)
.on('shopify:section:select', change_thumbSlider)
.on('shopify:section:deselect', change_thumbSlider)
.on('shopify:block:select', change_thumbSlider)
.on('shopify:block:deselect', change_thumbSlider);
...
function equalizer(){
  ...
  var max = -1;
  $(".free-shipping-part").css('min-height', 'auto'); 	
  $('.free-shipping-part').each(function() {
    var minHeight = $(this).innerHeight();
    max = minHeight > max ? minHeight : max;              
  });  
  $(".free-shipping-part").css('min-height',max)
  
  var max = -1;
  $(".search_result .blog-fig-part").css('min-height', 'auto'); 	
  $('.search_result .blog-fig-part').each(function() {
    var minHeight = $(this).innerHeight();
    max = minHeight > max ? minHeight : max;              
  });  
  $(".search_result .blog-fig-part").css('min-height',max)
...
(function() {
    $(function() {
        ...
        $('.featured-part, .collection-wrap').each(function() {
            $(this).find('.product-grid-desc').matchHeight({
                byRow: byRow
            });
        });
        $('.featured-part, .collection-wrap').each(function() {
            $(this).find('.product-grid figure').matchHeight({
                byRow: byRow
            });
        });
        $('.free-shipping-section').each(function() {
            $(this).find('.free-shipping-part').matchHeight({
                byRow: byRow
            });
        });
    });
    ...
    addtocart_form: function(form_id, callback, errorCallback){
      var ajax = {
        ...
        success: function(item){
          ...
          jQuery('#added_product_popup').find('h3').html('<strong>'+ item.product_title + '</strong><span class="'+ item.variant_title +'">'+ item.variant_title +'</span><p>Added to your Cart</p>');
